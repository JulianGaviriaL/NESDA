function [CP2,Disp,Std_Clusters,idx,d,sfrac] = Run_Clustering_Sim(XONn,n_clusters,mask,brain_info,maskP,maskN,n_rep,idx_sep_seeds,SeedType)
    ...
    % I need to remove seed voxels for the clustering...
    
    
    [idx,CP] = kmeans(XONn',n_clusters,'distance','correlation','replicates',n_rep,'empty','drop','maxiter',100);
